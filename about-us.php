        ...
        <div class="container">
            <div class="video-text">
                ...
                <div class="video-play-btn">
                    <a href="https://www.youtube.com/watch?v=eDnQWFhNrso" class="pop-up"><i class="fa fa-play"></i></a>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="gallery-text">
                        ...
                        <a href="./gallery.php" class="primary-btn">View Gallery <i class="lnr lnr-arrow-right"></i></a>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="row">
